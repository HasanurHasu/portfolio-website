            ...
            <div className='max-w-5xl mx-auto py-4'>
                <div className='grid grid-cols-2 gap-5'>
                    <div className='flex justify-center items-center' style={{ backgroundColor: 'rgba(33, 158, 188, 0.2)' }}>
                        <img src={brand} alt="" className='w-96' />
                    </div>
                    <div className='space-y-4 text-lg'>
                        <h1 className='text-4xl font-bold text-blue-500'>Brand Shop</h1>
                        ...
                        <ul className="list-decimal ml-4">
                            <li>Online Database System.</li>
                            <li>Login/Registration system.</li>
                            <li>Users can manage profile, adding new items, and
                        ...
                        <div className="flex mt-5 gap-3">
                            ...
                            <a href="https://github.com/HasanurHasu/brandshop-server-side-assignment" target="_blank" rel="noreferrer">
